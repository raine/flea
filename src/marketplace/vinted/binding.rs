...
pub struct VintedPortalBinding {
    ...
    pub host: &'static str,
    pub portal_api_host: &'static str,
    pub native_api_host: &'static str,
    pub shipping_api_host: &'static str,
...
pub const VINTED_FI_BINDING: VintedPortalBinding = VintedPortalBinding {
    ...
    portal_api_host: "https://www.vinted.fi",
    native_api_host: "https://api.vinted.com",
    shipping_api_host: "https://api.vinted.fi",
    locale: "fi",
    iso_locale: "fi-FI",
...
mod tests {
    ...
    fn validated_binding_keeps_host_and_client_profile_distinct() {
        ...
        assert_eq!(VINTED_FI_BINDING.portal_api_host, "https://www.vinted.fi");
        assert_eq!(VINTED_FI_BINDING.native_api_host, "https://api.vinted.com");
        assert_eq!(VINTED_FI_BINDING.shipping_api_host, "https://api.vinted.fi");
